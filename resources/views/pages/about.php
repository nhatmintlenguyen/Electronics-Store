...
<section class="grid grid-cols-1 gap-8 lg:grid-cols-[1.15fr_0.85fr]">
    <div class="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm dark:border-slate-800 dark:bg-slate-900">
        ...
        <p class="mt-4 text-sm leading-7 text-slate-600 dark:text-slate-400">
            TechStore is an e-commerce website developed for the Web Programming project, focused on AJAX search, product categories, user authentication, and physical store availability.
        </p>
        <div class="mt-6 grid gap-4 sm:grid-cols-2">
            <div class="rounded-2xl bg-slate-50 p-5 dark:bg-slate-800">
                ...
                <p class="mt-2 text-sm text-slate-600 dark:text-slate-400">HTML5, utility-first CSS, vanilla JavaScript, AJAX search, and category filtering.</p>
            </div>
            <div class="rounded-2xl bg-slate-50 p-5 dark:bg-slate-800">
                <h2 class="font-bold text-slate-900 dark:text-white">Backend</h2>
                <p class="mt-2 text-sm text-slate-600 dark:text-slate-400">PHP, PDO, and MySQL for products, categories, users, and store locations.</p>
            </div>
        </div>
    </div>

    <aside class="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm dark:border-slate-800 dark:bg-slate-900">
        <h2 class="text-xl font-bold text-slate-900 dark:text-white">Quick Contact</h2>
        <div class="mt-5 space-y-4 text-sm text-slate-600 dark:text-slate-400">
            ...
            <p class="flex items-center gap-3"><span class="material-symbols-outlined text-primary">location_on</span>Hanoi, Vietnam</p>
        </div>
